        ...
        (function (components) {
            var MyCoReTEILayerProvider = (function (_super) {
                ...
                function MyCoReTEILayerProvider(_settings) {
                    ...
                    _this._model = null;
                    if (_this._settings.derivateContentTransformerServlet == null) {
                        _this._settings.derivateContentTransformerServlet =
                        _this._settings.webApplicationBaseURL + "servlets/MCRDerivateContentTransformerServlet/";
                    }

                    _this.contentLocation = null;
                    _this.contentLocation = this._settings.derivateContentTransformerServlet + _this._settings.derivate + "/";
                    return _this;
                }
