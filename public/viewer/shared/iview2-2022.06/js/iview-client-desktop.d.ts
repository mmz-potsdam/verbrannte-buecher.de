...
declare namespace mycore.viewer.components {
    class MyCoReDesktopToolbarProviderComponent extends ViewerComponent {
        private _settings;
...
declare namespace mycore.viewer.model {
    class MyCoReViewerSearcher {
        constructor();
        index(model: model.StructureModel, textContentResolver: (id: string, callback: (id: string, textContent: model.TextContentModel) => void) => void, processIndicator: (x: any, ofY: any) => void): void;
        model: model.StructureModel;
        textContentResolver: (id: string, callback: (id: string, textContent: model.TextContentModel) => void) => void;
        processIndicator: (x: any, ofY: any) => void;
...
declare namespace mycore.viewer.components.events {
    class ProvideViewerSearcherEvent extends MyCoReImageViewerEvent {
        ...
        readonly searcher: model.MyCoReViewerSearcher;
        static TYPE: string;
    }
}
declare namespace mycore.viewer.widgets.canvas {
...
declare namespace mycore.viewer.widgets.index {
    class TextIndex<T> {
        ...
        constructor(_fullTextProvider: (T: any) => string);
...
declare namespace mycore.viewer.widgets.solr {
    class SolrSearchRequest {
        private solrHandlerURL;
        private derivateID;
        query: string;
        requestCallback: (success: boolean) => void;
        constructor(solrHandlerURL: string, derivateID: string, query: string, requestCallback: (success: boolean) => void);
        static BASE_TEMPLATE: string;
        private request;
        private _solrRequestResult;
        private _isComplete;
        readonly solrRequestResult: HighlightPage[];
...
declare namespace mycore.viewer.model {
    ...
    class MyCoReSolrSearcher extends MyCoReViewerSearcher {
        private solrHandlerURL;
        private derivateId;
        constructor(solrHandlerURL: string, derivateId: string);
        private resolver;
        index(model: model.StructureModel, textContentResolver: (id: string, callback: (id: string, textContent: model.TextContentModel) => void) => void, processIndicator: (x: any, ofY: any) => void): void;
        private static TEXT_HIGHLIGHT_CLASSNAME;
        private _altoHrefPageMap;
        private _currentRequest;
        private static TEXT_HREF;
        search(query: string, resultReporter: (objects: Array<ResultObject>) => void, searchCompleteCallback: () => void, count?: number, start?: number): void;
        extractSearchResults(query: string, solrResult: Array<widgets.solr.HighlightPage>): Array<ResultObject>;
    }
    class SolrAltoTextContent implements model.TextElement {
...
declare namespace mycore.viewer.components {
    class MyCoReSolrSearcherProvider extends ViewerComponent {
        private _settings;
        constructor(_settings: SolrSearcherSettings);
        readonly handlesEvents: string[];
        init(): void;
    }
    class SolrSearcherSettings extends MyCoReViewerSettings {
