        ...
        (function (model) {
            var MyCoReMobileToolbarModel = (function (_super) {
                ...
                function MyCoReMobileToolbarModel() {
                    return _super.call(this, "MyCoReMobileToolbar") || this;
                }
        ...
        (function (components) {
            var MyCoReImagebarComponent = (function (_super) {
                ...
                function MyCoReImagebarComponent(_settings, _container) {
                    ...
                    if (_this._settings.mobile) {
                        _this.trigger(new components.events.WaitForEvent(_this, components.events.StructureModelLoadedEvent.TYPE));
                    }
                    return _this;
                }
        ...
        (function (widgets) {
            ...
            (function (toolbar) {
                var MobileToolbarViewFactory = (function () {
                    ...
                    MobileToolbarViewFactory.prototype.createGroupView = function (id, order, align) {
