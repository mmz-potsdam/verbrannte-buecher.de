...
declare class Debounce<T> {
    private time;
    private handler;
    private _timeout;
    constructor(time: number, handler: (param: T) => void);
    call(param: T): void;
}
...
declare namespace mycore.viewer.widgets.canvas {
    class Viewport {
        ...
        readonly currentAnimation: mycore.viewer.widgets.canvas.Animation;
...
declare namespace mycore.viewer.widgets.canvas {
    class PageArea implements ViewerPropertyObserver<any> {
        ...
        private pageIntersectViewport;
        private registerPageAreaInformationEvents;
        private unregisterPageAreaInformationEvents;
    }
    class PageAreaInformation {
        private _positionProperty;
        private _scaleProperty;
        private _rotationProperty;
        readonly positionProperty: ViewerProperty<Position2D>;
        readonly rotationProperty: ViewerProperty<number>;
        readonly scaleProperty: ViewerProperty<number>;
        rotation: number;
        scale: number;
        position: Position2D;
    }
...
declare namespace mycore.viewer.widgets.canvas {
    class TextRenderer {
        ...
        private removePage;
        private addPageParts;
        private removeContentPart;
        private createContentPart;
    }
}
declare namespace mycore.viewer.widgets.canvas {
...
declare namespace mycore.viewer.widgets.canvas {
    class Scrollbar {
        ...
        resized(): void;
        readonly scrollbarElement: JQuery;
        scrollHandler: () => void;
    }
}
declare namespace mycore.viewer.widgets.canvas {
...
declare namespace mycore.viewer.widgets.canvas {
    class PageController {
        ...
        readonly viewport: mycore.viewer.widgets.canvas.Viewport;
        readonly views: Array<mycore.viewer.widgets.canvas.PageView>;
        addPage(page: model.AbstractPage, info: PageAreaInformation): void;
        removePage(page: model.AbstractPage): void;
        getPages(): Array<model.AbstractPage>;
        setPageAreaInformation(page: model.AbstractPage, info: PageAreaInformation): void;
...
declare namespace mycore.viewer.widgets.toolbar {
    class ToolbarGroup {
        ...
        private _order;
        private _right;
        constructor(_name: string, _order: number, _right?: boolean);
        ...
        readonly observer: ContainerObserver<ToolbarGroup, ToolbarComponent>[];
        readonly name: string;
...
declare namespace mycore.viewer.widgets.toolbar {
    class ToolbarModel extends widgets.toolbar.ToolbarGroup implements ContainerObserver<ToolbarGroup, ToolbarComponent> {
        ...
        private notifyGroupAdded;
        private notifyGroupRemoved;
        addComponent(component: ToolbarComponent): void;
        removeComponent(component: ToolbarComponent): void;
    }
}
...
declare namespace mycore.viewer.widgets.toolbar {
    class ButtonController implements ContainerObserver<ToolbarGroup, ToolbarComponent>, ViewerPropertyObserver<any> {
        ...
        readonly eventManager: widgets.events.ViewerEventManager;
...
declare namespace mycore.viewer.widgets.layout {
    class IviewBorderLayout {
        ...
        private _correctDescription;
        private _updateCssDescription;
        updateSizes(): void;
        private _initContainerResizeable;
        private _descriptionMap;
        private _containerMap;
        private _getNewSize;
        hasContainer(direction: number): boolean;
        getContainer(direction: number): JQuery;
        readonly horizontalStronger: any;
        ...
        private getDirectionDescription;
    }
...
declare namespace mycore.viewer.model {
    class StructureImage {
        ...
        width?: number;
        height?: number;
        constructor(type: string, id: string, order: number, orderLabel: string, href: string, mimetype: string, requestImgdataUrl: (callback: (imgdata: string) => void) => void, additionalHrefs?: MyCoReMap<string, string>, uniqueIdentifier?: string, width?: number, height?: number);
...
declare namespace mycore.viewer.components.events {
    class ImageChangedEvent extends MyCoReImageViewerEvent {
        ...
        readonly image: model.StructureImage;
        static TYPE: string;
    }
}
declare namespace mycore.viewer.components.events {
...
declare namespace mycore.viewer.model {
    class StructureChapter {
        ...
        constructor(_parent: StructureChapter, _type: string, _id: string, _label: string, _chapter?: Array<StructureChapter>, _additional?: MyCoReMap<string, any>, _destinationResolver?: (callbackFn: (targetId: any) => void) => void);
        readonly parent: StructureChapter;
        readonly type: string;
        readonly id: string;
        readonly label: string;
        chapter: Array<StructureChapter>;
        readonly additional: MyCoReMap<string, any>;
        resolveDestination(callbackFn: (targetId: any) => void): void;
    }
}
declare namespace mycore.viewer.model {
...
declare namespace mycore.viewer.components.events {
    class StructureModelLoadedEvent extends MyCoReImageViewerEvent {
        ...
        readonly structureModel: model.StructureModel;
        static TYPE: string;
    }
}
declare namespace mycore.viewer.components.events {
...
declare namespace mycore.viewer.components.events {
    class LanguageModelLoadedEvent extends MyCoReImageViewerEvent {
        ...
        readonly languageModel: model.LanguageModel;
        static TYPE: string;
    }
}
declare namespace mycore.viewer.components.events {
...
declare namespace mycore.viewer.components {
    class MyCoReToolbarComponent extends ViewerComponent {
        ...
        handle(e: mycore.viewer.widgets.events.ViewerEvent): void;
        readonly handlesEvents: string[];
        readonly toolbar: widgets.toolbar.IviewToolbar;
...
declare namespace mycore.viewer.widgets.thumbnail {
    ...
    class DefaultThumbnailOverviewSettings implements ThumbnailOverviewSettings {
        ...
        readonly thumbnails: ThumbnailOverviewThumbnail[];
        readonly container: JQuery;
        readonly maxThumbnailSize: Size2D;
        readonly inputHandler: ThumbnailOverviewInputHandler;
    }
}
declare namespace mycore.viewer.widgets.thumbnail {
...
declare namespace mycore.viewer.widgets.chaptertree {
    ...
    class DefaultChapterTreeSettings implements ChapterTreeSettings, ChapterTreeViewFactory {
        ...
        readonly chapter: ChapterTreeChapter;
        readonly chapterLabelMap: MyCoReMap<string, string>;
        readonly container: JQuery;
        readonly viewFactory: this;
        readonly inputHandler: ChapterTreeInputHandler;
        createChapterTeeView(): ChapterTreeView;
    }
}
declare namespace mycore.viewer.widgets.chaptertree {
...
declare namespace mycore.viewer.components.events {
    class ChapterChangedEvent extends MyCoReImageViewerEvent {
        ...
        readonly chapter: model.StructureChapter;
        static TYPE: string;
    }
}
declare namespace mycore.viewer.components.events {
...
declare namespace mycore.viewer.components {
    class MyCoReChapterComponent extends ViewerComponent implements widgets.chaptertree.ChapterTreeInputHandler {
        ...
        readonly handlesEvents: string[];
        handle(e: mycore.viewer.widgets.events.ViewerEvent): void;
        private persistChapterToString;
        private createChapterLabelMap;
        register(): void;
        registerNode(node: JQuery, id: string): void;
        private setChapter;
        registerExpander(expander: JQuery, id: string): void;
...
declare namespace mycore.viewer.widgets.modal {
    ...
    class IviewModalWindow {
        ...
        readonly modalContent: JQuery;
        readonly modalHeader: JQuery;
        readonly modalBody: JQuery;
        readonly modalFooter: JQuery;
        show(): void;
        hide(): void;
        readonly closeButton: JQuery;
        closeLabel: string;
        title: string;
...
declare namespace mycore.viewer.widgets.i18n {
    class XMLI18NProvider implements I18NProvider {
        ...
        getLanguage(href: string, callback: (model: model.LanguageModel) => void, errorCallback?: (err: any) => void): void;
    }
    interface I18NProvider {
        getLanguage(href: string, callback: (model: model.LanguageModel) => void, errorCallback?: (err: any) => void): any;
    }
...
declare namespace mycore.viewer.widgets.canvas {
    class PageLayout {
        init(model: OrderedListModel, pageController: PageController, pageDimension: Size2D, horizontalScrollbar: Scrollbar, verticalScrollbar: Scrollbar, pageLoader: (number: any) => void): void;
...
declare namespace mycore.viewer.components {
    class MyCoReImageScrollComponent extends ViewerComponent {
        ...
        private changePageLayout;
        private loadPageIfNotPresent;
        private restorePermalink;
        handle(e: mycore.viewer.widgets.events.ViewerEvent): void;
        private setAltoOnTop;
        isAltoSelectable(): boolean;
        private setAltoSelectable;
        private setSelectableButtonEnabled;
        private addLayout;
        ...
        private _imageByHref;
        private registerDesktopInputHandler;
        private registerTouchInputHandler;
    }
}
declare namespace mycore.viewer.model {
    interface Layer {
...
declare namespace mycore.viewer.widgets.layer {
    class LayerDisplayController {
        ...
        private addLayerView;
        private createLayerView;
        private removeLayerView;
        private getLayerView;
        private cleanLayerView;
...
declare namespace mycore.viewer.components {
    class MyCoReLayerComponent extends ViewerComponent {
        ...
        readonly handlesEvents: string[];
        handle(e: mycore.viewer.widgets.events.ViewerEvent): void;
        private toggleTranscriptionContainer;
