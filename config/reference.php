 ...
 *     },
 * }
 * @psalm-type LiipUrlAutoConverterConfig = array{
 *     linkclass?: scalar|null, // Default: ""
 *     target?: scalar|null, // Default: "_blank"
 *     debugmode?: scalar|null, // Default: false
 * }
 ...
 *     default_locale: scalar|null,
 *     locales?: list<scalar|null>,
 *     catalogue?: scalar|null, // Default: "routes"
 *     strategy?: scalar|null, // Default: "custom"
 *     prefix_with_locale?: bool, // Default: false
 *     omit_prefix_when_default?: bool, // Default: true
 *     hosts?: array<string, scalar|null>,
 *     redirect_to_host?: bool, // Default: true
 *     use_cookie?: bool, // DEPRECATED! Please use: cookie.enabled // Default: true
 *     cookie?: array{
 *         enabled?: bool, // Default: true
 *         name?: scalar|null, // Default: "hl"
 *         lifetime?: scalar|null, // Default: 31536000
 ...
 * }
 * @psalm-type EkoFeedConfig = array{
 *     hydrator?: scalar|null, // Default: "Eko\\FeedBundle\\Hydrator\\DefaultHydrator"
 *     translation_domain?: scalar|null, // Default: null
 *     feeds?: array<string, array{ // Default: []
 *         title: scalar|null,
 *         description: scalar|null,
 *         link: string|array{
 *             route_name?: scalar|null,
 *             route_params?: array<string, scalar|null>,
 *             uri?: scalar|null,
 *         },
 ...
 *     enabled?: bool, // When disabled, ScssPHP will not compile SCSS sources automatically, by user's request. Compiling with CLI tool will still work. // Default: true
 *     autoUpdate?: bool, // Automatically re-compile SCSS sources on updates, when enabled. // Default: true
 *     assets?: array<string, array{ // Default: []
 *         src: scalar|null, // Path to SCSS source file (entrypoint), relative to Symfony's project directory.
 *         outputFolder?: scalar|null, // Prepends this outputFolder to asset's destination path. // Default: "public"
 *         importPaths?: list<scalar|null>,
 *         variables?: array<string, scalar|null>,
 *         outputStyle?: "expanded"|"compressed", // Expanded or compressed CSS output. // Default: "compressed"
 *         sourceMap?: bool, // When enabled, the CSS file contains inline sourceMap comments. // Default: false
 *         appendTimestamp?: bool, // When enabled, the timestamp of the asset, will be appended as query string. // Default: true
 *     }>,
 * }
